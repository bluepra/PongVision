# Original T-RexRuner forked from `ahmed4end``
#   https://github.com/ahmed4end/T-Rex-Runner-Python
#   
#   Modified to now use VideoProcessor to use 
#   head tracking instead of keyboard.
...
# Resources filepath
resource_path = "dino-game/resources.png"
